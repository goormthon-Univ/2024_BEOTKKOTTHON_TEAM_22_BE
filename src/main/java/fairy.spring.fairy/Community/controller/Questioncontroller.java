...
public class Questioncontroller {
    ...
    public ResponseEntity<?> createQuestionImage(@PathVariable("question_id") Long question_id,@ModelAttribute("imageurl") CommunityRequest.questionImageRequestDTO questionImageRequestDTO) {
